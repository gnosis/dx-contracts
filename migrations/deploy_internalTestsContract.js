...
module.exports = function deploy(deployer) {
  deployer.deploy(InternalTests, { gas: 4612388 })
  // DutchExchange.deployed().then((dx) => {
  ...
  //   return initParams
  // }).then((initParams) => {
  //   console.log(`deploying InternalFunctionstest contract with ${initParams}`)
  //   return  deployer.deploy(InternalTests, ...initParams, { gas: 4612388 })
  // })
