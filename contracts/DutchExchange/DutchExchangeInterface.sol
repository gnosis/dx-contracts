...
contract DutchExchangeInterface {
    ...
    function DutchExchangeInterface(
        address _TUL,
        address _OWL,
        address _owner, 
        address _ETH,
        ...
        public
    {
        ...
        sellVolumes[token1][token2][0]=1;
        buyVolumes[token1][token2][0]=1;
        ...
        returns (uint num, uint den)
    {
        ...
        if (auctionIndex < latestAuctionIndex) {
            ...
            else (sellTokenNum, sellTokenDen)=(1,1);
            ...
            else{ (buyTokenNum, buyTokenDen)=(1,1);
            }
        ...
        returns (uint fee)
    {
        ...
        if (fee > 0) {
            ...
            // Adjust fee
            fee -= amountOfWIZBurned * tokenPriceDen / tokenPriceNum / PriceOracleInterface(ETHUSDOracle).getUSDETHPrice() ;
        }
    }
